...
parser.add_argument(
    "--note", type=str, help="Note to add to the rows of the file (--model by default)."
)
parser.add_argument(
    "--model",
    type=str,
...
parser.add_argument(
    "--baseurl",
    type=str,
    default="https://api.openai.com:443/v1",
...
def chat(prompt: str):
    ...
    result = client.chat.completions.create(
        ...
        messages=[
            {
                "role": "system",
                "content": "You are a very verbose and helpful assistant",
            },
